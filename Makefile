# Networked Intellivision Boxing (Mattel 1980) over FujiNet.
# Strictly 2-player lockstep netplay, simultaneous (no turn arbiter).
...
rig: $(RELAY_DEP)
	$(MAKE) SRV_HOST=127.0.0.1 SRV_PORT=9112 $(RIG_BINS)
	$(MAKE) check-7000
...
lobby: $(RELAY_DEP)
	$(MAKE) SRV_HOST=127.0.0.1 SRV_PORT=9112 $(BUILD)/$(GAME)_net.bin
