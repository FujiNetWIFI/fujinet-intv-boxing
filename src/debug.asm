...
TRACE_RANGES:
        ...
        ; Native timer state.  SC_CNT2-SC_CNT7 mirror the three real,
        ; timer-API-stoppable countdowns (ram.asm) -- the ranges keep the
        ; family's exact spans, covering the always-zero RS_SPARE cells
        ...
        DECLE   SC_CNT2, SC_CNT7+1      ; $8196-$819B (all six real)
